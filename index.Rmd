...
author      : |
  Freya Watkins, materials: Joseph V. Casillas 🙏 (used with permission) 
date        : |
  Psycholinguistics Lab Meeting | 2021-11-05
output:
...
.Large[
.white[a version control system that lets you manage and keep track of your source code history via repositories]
...
5. Check GitHub in the browser to see if it worked
